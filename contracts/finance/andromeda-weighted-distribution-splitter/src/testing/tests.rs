...
use cosmwasm_std::{
    ...
    Addr, BankMsg, Coin, CosmosMsg, DepsMut, QuerierWrapper, Response, SubMsg, Uint128,
};
        ...
        .add_submessages(vec![
            SubMsg::new(
                ...
                CosmosMsg::Bank(BankMsg::Send {
                    ...
                    amount: vec![Coin::new(10000u128_u128, "uluna")],
                }),
            ),
            // amp_msg,
        ])
...
fn test_send_with_config_locked(locked_splitter: (DepsMut<'static>, Splitter)) {
    ...
    let info = message_info(&Addr::unchecked("owner"), &[Coin::new(10000u128_u128, "uluna")]);
