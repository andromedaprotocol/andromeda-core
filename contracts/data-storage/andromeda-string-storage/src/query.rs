...
use andromeda_data_storage::string_storage::{GetDataOwnerResponse, GetValueResponse, StringStorageRestriction};
...
pub fn has_permission(
    ...
    let allowed = match RESTRICTION.load(storage)? {
        ...
        StringStorageRestriction::Restricted => match DATA_OWNER.load(storage).ok() {
