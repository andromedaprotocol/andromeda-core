...
pub const CONDITION_ADO_ADDRESS: Item<String> = Item::new("condition_ado_address");

// The address of the ADO we want to query data from
pub const ORACLE_ADO_ADDRESS: Item<String> = Item::new("query_ado_address");

// Task balancer ADO address
pub const TASK_BALANCER_ADDRESS: Item<String> = Item::new("task_balancer_address");
