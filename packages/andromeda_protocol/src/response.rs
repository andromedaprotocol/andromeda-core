...
// //Taken from: https://raw.githubusercontent.com/CosmWasm/cw-plus/v0.10.3/packages/cw0/src/parse_reply.rs
// //cw20 crate not imported to avoid versioning issues
// use thiserror::Error;

// use cosmwasm_std::{Binary, Reply, StdResult};
...
//     let data = parse_reply_instantiate_data(msg).unwrap();
